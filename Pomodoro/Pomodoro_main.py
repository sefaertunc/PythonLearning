...
tomato_canvas.create_text(100,130, text="00:00", fill="white", font= (FONT_NAME, 35, "bold"))
tomato_canvas.grid(column=1, row=1)

title_label = tk.Label(text="Timer", font=(FONT_NAME, 45, "bold"), bg=YELLOW, fg=GREEN)
title_label.grid(column=1, row=0)

start_button = tk.Button(width=5,text="Start", font=FONT_NAME)
start_button.grid(column=0, row=2)

reset_button = tk.Button(width=5,text="Reset",font=FONT_NAME)
